...
// DK: dummy wrapper to represent test_ostream. The point is to throw away
...
typedef boost::archive::hdf5_oarchive test_oarchive;
typedef test_stream_wrapper test_ostream;
#include <boost/archive/hdf5_iarchive.hpp>
typedef boost::archive::hdf5_iarchive test_iarchive;
