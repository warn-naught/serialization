...
protected:
    ...
    save_override(boost::archive::object_id_type const& t);
	BOOST_ARCHIVE_OR_WARCHIVE_DECL(void) 
    save_override(boost::archive::object_reference_type const& t);
	BOOST_ARCHIVE_OR_WARCHIVE_DECL(void) 
	save_override(boost::archive::version_type const& t);
	BOOST_ARCHIVE_OR_WARCHIVE_DECL(void) 
    save_override(boost::archive::class_id_type const& t);
	BOOST_ARCHIVE_OR_WARCHIVE_DECL(void) 
    save_override(boost::archive::class_id_optional_type const& t);
	BOOST_ARCHIVE_OR_WARCHIVE_DECL(void) 
    save_override(boost::archive::class_id_reference_type const& t);
	BOOST_ARCHIVE_OR_WARCHIVE_DECL(void) 
    save_override(boost::archive::class_name_type const& t);
	BOOST_ARCHIVE_OR_WARCHIVE_DECL(void) 
    save_override(boost::archive::tracking_type const& t);
